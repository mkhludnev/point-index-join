...
public class JoinIndexQuery2 extends Query implements  AutoCloseable{
    ...
    public JoinIndexQuery2(IndexSearcher fromSearcher, Query fromQuery, String fromField, String toField, SearcherManager indexManager, Supplier<IndexWriter> writerFactory) {
    ...
    public Query rewrite(IndexSearcher indexSearcher) throws IOException {
        ...
        if (rewrittenFrom != toRewriteFrom) {
            return new JoinIndexQuery2(fromSearcher, rewrittenFrom, fromField, toField, indexManager, writerFactory) {
                {
                    this.closeables = JoinIndexQuery2.this.closeables;
                }
                @Override
                public Query rewrite(IndexSearcher indexSearcher) throws IOException {
                    return this;
    ...
    public Weight createWeight(IndexSearcher searcher, ScoreMode scoreMode, float boost) throws IOException {
        return new JoinIndexWeight2(this, scoreMode, JoinIndexQuery2.this.closeables::add);
    }
